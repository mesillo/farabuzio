...
class ArrayIterator {
	constructor( elements ) {
		this.iterator = arrayIterator( packets );
	}
...
//const iterator = new ArrayIterator( packets );
//const generator = new DataGenerator( iterator );
const generator = new DataGenerator( packets );

class tcpClient { // TODO: unused.
